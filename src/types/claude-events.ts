...
export type ClaudeEvent =
  ...
  | { event_type: "SubagentSpawned"; session_id: number; agent_type: string; agent_id: string; description: string; prompt: string; run_in_background: boolean; parent_agent_id: string | null; timestamp: string }
